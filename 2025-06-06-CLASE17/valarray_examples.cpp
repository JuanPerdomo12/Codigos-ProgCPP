...
int main()
{
    ...
    v2 = v1[std::slice(0,3,2)]; // (4): from slice array, arranca en 0 hasta un tamaño de 3 dando saltos de 2
    print("every 2nd element starting at pos 0:", v2);

    v2 = v1[v1 % 2 == 0]; // (6): from mask array
    print("values that are even:", v2);

    std::valarray<int> v3 = v1[v1 < 3];
    print("values that are less than 3:", v3);
